...
readAndReplace('app/secure-call/[token]/page.tsx', [
    ...
    // Button styling inside call page
...
readAndReplace('components/design/PremiumInput.tsx', [
    [/className="[^"]*bg-white\/10[^"]*"/g, 'className="w-full bg-transparent px-4 py-3 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all outline-none text-gray-800"']
]);
