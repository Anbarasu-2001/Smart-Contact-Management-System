...
const endStr = ') : activeView === \'contacts\'';
                    ...
                    <div className="bg-white/60 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/40 hover:scale-[1.02] transition-all duration-300 col-span-1 flex flex-col h-full">
                        ...
                        <div className="flex flex-col gap-3 overflow-y-auto max-h-[300px] scroll-smooth pr-1">
                            {[
                                ...
                                { name: 'Designers', members: 4, color: 'from-purple-400 to-violet-600' }
                            ].map((group, idx) => (
                                <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-white/40 border border-white/40 hover:bg-white/60 transition-colors cursor-pointer">
                                    <div className="flex items-center gap-3">
                                        <div className={\`w-10 h-10 rounded-xl bg-gradient-to-br \${group.color} flex items-center justify-center text-white shadow-md\`}>
                                            <span className="font-bold text-sm">{group.name.charAt(0)}</span>
                                        </div>
                                        <div className="flex flex-col">
